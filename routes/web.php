...
Route::get('/blogdetails', [App\Http\Controllers\Frontend\BlogDetailsController::class, 'index'])->name('blogdetails.index');
...
// Admin Area Routes (Protected by Authentication)
